            ...
            <div class="col-md-10">
                <div class="card" style="width: 100%;">
                    <div class="card-body">
                        ...
                        <form method="POST" class="form-envia-documentos" id="cria-notificacao" action="{{route('noticias.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <input id="destaque" name="destaque" type="checkbox" @if(old('publicar') == "on") checked @endif>
