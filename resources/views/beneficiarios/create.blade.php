                            ...
                            <div class="form-row">
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input id="nis" class="form-control @error('nis') is-invalid @enderror" type="string" name="nis" value="{{old('nis')}}" required autofocus autocomplete="nis" placeholder="Digite seu NIS aqui...">
                                        @error('nis')
                                            <div id="validationServer03Feedback" class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input id="orgao_emissor" class="form-control @error('orgao_emissor') is-invalid @enderror" type="text" name="orgao_emissor" value="{{old('orgao_emissor')}}" required autocomplete="orgao_emissor" placeholder="O orgão emissor do RG...">
                                        @error('orgao_emissor')
                                            <div id="validationServer03Feedback" class="invalid-feedback">
                                                {{ $message }}
                                            </div>
