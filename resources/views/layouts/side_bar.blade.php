                                ...
                                <div id="card-notificacao" aria-live="polite" aria-atomic="true" style="position: relative; z-index: 1;">
                                    <div class="card" style="position: absolute; right: 0; top: 0; width: 300px;">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    Você precisa cumprir as exigências do requerimento de {{Auth::user()->requerimentosDocumentosExigidosNotificacao()->tipoString()}} da empresa {{Auth::user()->requerimentosDocumentosExigidosNotificacao()->empresa->nome}} para que sua licença seja liberada!
                                                </div>
                                            </div>
                                            <br>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <a href="{{route('requerimento.exigencias.documentacao', Auth::user()->requerimentosDocumentosExigidosNotificacao()->id)}}">Clique aqui</a> para ir à página
                                                </div>
                                            </div>
                                        </div>
                                    </div>
