                        ...
                        <form method="POST" id="criar-visita" action="{{route('visitas.store')}}">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="date" @error('data_marcada') is-invalid @enderror id="data_marcada" name="data_marcada" required autofocus autocomplete="data_marcada">
                    ...
                    <div class="card-footer">
                        <div class="form-row">
                            ...
                            <div class="col-md-6" style="text-align: right">
                                <button type="submit" class="btn btn-success" form="criar-visita" style="width: 100%">Salvar</button>
                            </div>
                        </div>
                    </div>
                </div>
