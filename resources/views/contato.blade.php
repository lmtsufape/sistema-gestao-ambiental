                ...
                <form method="POST" action="{{route('enviar.mensagem')}}">
                    ...
                    <div class="form-row">
                        <div class="col-md-12 form-group">
                            ...
                            <input type="text" class="form-control @error('nome_completo') is-invalid @enderror" name="nome_completo" placeholder="Fulano de tal">
                    ...
                    <div class="form-row">
                        <div class="col-md-12 form-group">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="exemplo@gmail.com">
                    ...
                    <div class="form-row">
                        <div class="col-md-12 form-group">
                            ...
                            <textarea class="form-control @error('mensagem') is-invalid @enderror" name="mensagem" placeholder="Escreva sua mensagem aqui..." cols="30" rows="10"></textarea>
                    ...
                    <div class="form-row justify-content-center" style="">
                        <div class="col-md-4 form-group">
                            <button type="submit" class="btn btn-success btn-color-dafault">Enviar mensagem</button>
                        </div>
                    </div>
                </form>
            </div>
