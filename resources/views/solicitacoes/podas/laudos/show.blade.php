            ...
            <div class="col-md-10">
                <div class="card" style="width: 100%;">
                    <div class="card-body">
                        ...
                        <div>
                            <a class="icon-licenciamento" title="Mídia do laudo" data-toggle="modal" data-target="#modal-imagens" style="cursor: pointer; margin-left: 2px; margin-right: 2px;"><img width="25" src="{{asset('img/media.svg')}}"  alt="Mídia"></a>
                        </div>
                    </div>
                </div>
            </div>
