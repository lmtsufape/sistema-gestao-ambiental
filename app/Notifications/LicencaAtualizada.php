...
class LicencaAtualizada extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage())
                    ->line("A licença do requerimento de {$this->requerimento->tipoString()} da empresa {$this->requerimento->empresa->nome} foi atualizada.")
